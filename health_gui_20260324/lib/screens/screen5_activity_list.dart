          ...
          child: Column(
            ...
            children: [
              ...
              _buildActivityItem(
                ...
                badgeCount: _badgeCounts['트레일 러닝'] ?? 0,
                theme: theme,
              ),
              const SizedBox(height: 16),
              _buildActivityItem(
                ...
                icon: Icons.pool,
                title: '실내 수영',
                subtitle: 'Indoor Swimming',
                badgeCount: _badgeCounts['실내 수영'] ?? 0,
                theme: theme,
              ),
              const SizedBox(height: 16),
              _buildActivityItem(
                ...
                icon: Icons.waves,
                title: '야외 수영',
                subtitle: 'Outdoor Swimming',
                badgeCount: _badgeCounts['야외 수영'] ?? 0,
                theme: theme,
              ),
              const SizedBox(height: 16),
              _buildActivityItem(
                ...
                badgeCount: _badgeCounts['근력 운동'] ?? 0,
                theme: theme,
              ),
              const SizedBox(height: 16),
              _buildActivityItem(
                ...
                icon: Icons.sports,
                title: '기타 운동',
                subtitle: 'Other Workout',
                badgeCount: _badgeCounts['기타 운동'] ?? 0,
                theme: theme,
              ),
            ],
          ),
